        ...
        <div class="row">
            ...
            <div class="col-lg-2" id="spy">
                ...
                <ul class="nav nav-pills flex-column mt-lg-5">
                    ...
                    >
                    <a class="nav-link" href="admin/login.php"> <i class="fa fa-fw fa-user"></i>Admin</a>
                </button>
                <button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="customer/login.php"><i class="fa fa-fw fa-user"></i>Customer</a>
                </button>
 	<button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="features.php"><i class="fa fa-fw fa-user"></i>Features</a>
                </button>
	<button type="button" class="btn btn-block mt-lg-5 mt-3 w3ls-btn p-1 btn-theme text-white  text-uppercase font-weight-bold" 
                    >
                    <a class="nav-link" href="contact.php"><i class="fa fa-fw fa-phone" ></i>Contact</a>
                </button>
            ...
            <div class="col-lg-10 scrollspy-example pr-0" data-spy="scroll" data-target="#spy">
                ...
                <div id="home" class="w3ls-banner d-flex  align-items-center justify-content-center">
                    <div class="bnr-w3pvt text-center">
                        <h4>Welcome to!!</h4>
                        <h2 class="bnr-txt-w3">Customer Relationship Management For Banking</h2>
