<?php
	...
	if (isset($_POST["submit"])) 
		...
		$tax_id= $_POST["tax_id"];
		updateCustomer($customer_id,$first_name,$last_name,$gender,$email,$dob,$address_1,$address_2,$city,$state,$zip_code,$country,$mobile_phone,$home_phone,$account_no,$national_id,$tax_id);
				}  
    global $con;  
    $sql = "SELECT * FROM customer WHERE customer_id = '$customer_id' ";  
    $result = mysqli_query($con, $sql);  
    while($row = mysqli_fetch_array($result)) {    
		$globalcustomer_id = $row["customer_id"];
		$globalname = $row["first_name"];
		$gobaldob= $row["dob"];
...
<article> 	
	...
	<form action = "" enctype="multipart/form-data" method = "POST" align = "center">
		...
		?>
			<tr>
				<td> 				</td>
				<td> <input type = "text" name = "customer_id" value = "<?php echo $row["customer_id"]; ?>" required>				</td>
			...
			<tr>			
				<td> Address 1			</td>
				<td> <input type = "text" name = "address_1" value = "<?php echo $row["address_1"]; ?>" required>				</td>
			</tr>
			<tr>
				<td> Address 2		</td>
				<td> <input type = "text" name = "address_2" value = "<?php echo $row["address_2"]; ?>" required>				</td>
			</tr>
			<tr>
				<td> City		</td>
			...
			<tr>
				<td> Mobile Phone	</td>
				<td> <input type = "text" name = "mobile_phone" value = "<?php echo $row["mobile_phone"]; ?>" required>				</td>
			</tr>

			<tr>
				<td> Home Phone	</td>
				<td> <input type = "text" name = "home_phone" value = "<?php echo $row["home_phone"]; ?>" required>				</td>
			</tr>

			<tr>
				<td> Account Number	</td>
				<td> <input type = "text" name = "account_no" value = "<?php echo $row["account_no"]; ?>" required>				</td>
			</tr>

			<tr>
				<td> National Id	</td>
				<td> <input type = "text" name = "national_id" value = "<?php echo $row["national_id"]; ?>" required>				</td>
			</tr>

			<tr>
				<td> Tax Id	</td>
				<td> <input type = "text" name = "tax_id" value = "<?php echo $row["tax_id"]; ?>" required>				</td>
			</tr>
